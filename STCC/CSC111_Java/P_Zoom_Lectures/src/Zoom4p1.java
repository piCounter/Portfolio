...
import java.util.Scanner;
 ...
 public class Zoom4p1 {
    public static void main(String[] args) {
        ...
        // // input
        // System.out.print("Ener three points: ");
        ...
        //     double C = Math.toDegrees(Math.acos((Math.pow(c,2)-Math.pow(b,2)-Math.pow(a,2)) / (-2*b*a)));
